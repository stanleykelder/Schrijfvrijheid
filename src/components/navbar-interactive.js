...
const NavbarInteractive = (props) => {
  return (
    <nav
      data-role="Header"
      className={`navbar-interactive-navbar ${props.rootClassName} `}
    >
      <header
        data-thq="thq-navbar"
      ...
      >
        <Link to="/" className="navbar-interactive-navlink">
          <div className="navbar-interactive-container">
            <h1 className="navbar-interactive-logo">{props.Logo}</h1>
            <h3 className="navbar-interactive-logo1">{props.Logo21}</h3>
          </div>
        </Link>
        <div
        ...
        >
          ...
          >
            <Link to="/over-mij" className="navbar-interactive-navlink1">
              Over mij
            </Link>
            <Link to="/roman" className="navbar-interactive-navlink2">
              Roman
            </Link>
            <Link to="/blog" className="navbar-interactive-navlink3">
              Blog
            </Link>
          </nav>
        </div>
        ...
        >
          ...
          >
            <ButtonSolid
              button="Contact"
              rootClassName="button-solid-root-class-name9"
              className="navbar-interactive-component"
            ></ButtonSolid>
          </a>
        </div>
        <div
        ...
        >
          ...
          >
            <div className="navbar-interactive-container1">
              ...
              />
              <h1 className="navbar-interactive-logo2">{props.Logo1}</h1>
              <div
            ...
            >
              <Link to="/over-mij" className="navbar-interactive-navlink4">
                Over mij
              </Link>
              <Link to="/roman" className="navbar-interactive-navlink5">
                Roman
              </Link>
              <Link to="/blog" className="navbar-interactive-navlink6">
                Blog
              </Link>
            </nav>
            <div className="navbar-interactive-container2">
              <a
                href="mailto:marjangerrits@gmail.com?subject=Schrijfvrijheid"
                className="navbar-interactive-link1"
              >
                <ButtonSolid
                  button="Contact"
                  rootClassName="button-solid-root-class-name10"
                  className="navbar-interactive-component1"
                ></ButtonSolid>
              </a>
            </div>
          </div>
...
NavbarInteractive.defaultProps = {
  rootClassName: '',
  Logo21: 'Schrijfvrijheid',
  Logo1: 'Marjan Gerrits',
  Logo: 'Marjan Gerrits',
}

NavbarInteractive.propTypes = {
  rootClassName: PropTypes.string,
  Logo21: PropTypes.string,
